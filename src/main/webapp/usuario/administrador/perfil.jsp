                            ...
                            <div class="user-profile">
                                <div class="user-avatar">
                                    <label for="foto-perfil"><img
                                            src="${pageContext.request.contextPath}/public/uploads/${usuario.uriFotoUsuario}"
                                ...
                                <h6 class="user-email">@${usuario.idUsuario}</h6>
                            </div>
                            <div class="about">
                                <h5>Acerca de mi</h5>
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="card h-100">
                    <form id="modificar-perfil" class="card-body"
                          action="${pageContext.request.contextPath}/ServletControladorUsuario?action=update"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="apellido" name="apellido"
                                           value="${usuario.apellido}" placeholder="Introduce tus apellidos"
                                           minlength="3"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control password" id="password" name="password"
                                           value="${usuario.password}" placeholder="Introduce una contraseña"
                                           minlength="6"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="direccion" name="direccion"
                                           value="${usuario.direccion}" placeholder="Introduce tu direccion (Opcional)">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="telefono" name="telefono"
                                           value="${usuario.telefono}" placeholder="Introduce tu telefono (Opcional)">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                    ...
                    <form action="${pageContext.request.contextPath}/ServletControladorUsuario?action=logout"
                          method="post">
...
<script>
    function confirmMessage() {
        swal({
            title: "¿Estas seguro de que deseas borrar tu cuenta?",
            text: "Una vez borrada, no podrás seguir siendo administrador",
            icon: "warning",
            ...
            .then((willDelete) => {
                if (willDelete) {
                    document.location.href = "${pageContext.request.contextPath}/ServletControladorUsuario?action=delete&id-usuario=${usuario.idUsuario}"
                } else {
                    swal("¡Tu cuenta esta segura!");
                }
            });
    }
</script>
