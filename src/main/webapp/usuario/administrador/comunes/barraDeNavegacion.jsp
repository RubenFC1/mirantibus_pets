        ...
        <div class="collapse navbar-collapse text-center" id="navcol-1">
            <ul class="navbar-nav flex-fill justify-content-evenly">
                <li class="nav-item"><a class="nav-link active"
                                        href="${pageContext.request.contextPath}/usuario/administrador/administrarUsuarios.jsp"><i
               ...
               <!-- <li class="nav-item"><a class="nav-link active"
                ...
                <li class="nav-item"><a class="nav-link active"
                                        href="${pageContext.request.contextPath}/usuario/administrador/perfil.jsp"><img
                        style="width: 24px;height: 24px;"
                        src="${pageContext.request.contextPath}/public/uploads/${usuario.uriFotoUsuario}">&nbsp;Hola ${usuario.nombre}</a>
                </li>
