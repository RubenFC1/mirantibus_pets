        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 cust_blogteaser"
                    ...
                    <p class="text-secondary"
                       style="text-align: left;font-size: 14px;font-family: Montserrat, sans-serif;line-height: 22px;color: rgb(9,9,10);margin-left: 24px;">
                        Crea un perfil para tu mascota llenando los datos solicitados.<br><br></p><a class="h4" href="#"
                ...
                <div class="col-md-4 cust_blogteaser" style="padding-bottom:20px;margin-bottom:32px;">
                    <a href="registroMascota.jsp"><img
                    ...
                    <p class="text-secondary"
                       style="text-align: left;font-size: 14px;font-family: Montserrat, sans-serif;line-height: 22px;color: rgb(9,9,10);margin-left: 24px;">
                        Al encontrar a una mascota en situación de calle, puedes registrarla y ayudarla a encontrar un
                        nuevo hogar.</p>
                    <a class="h4" href="registroMascota.jsp"><i class="fa fa-arrow-circle-right"
